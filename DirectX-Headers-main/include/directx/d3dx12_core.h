...
// Fallback definitions for older D3D12 headers that don't expose tight-alignment flags/constants
#ifndef D3D12_RESOURCE_FLAG_USE_TIGHT_ALIGNMENT
#define D3D12_RESOURCE_FLAG_USE_TIGHT_ALIGNMENT 0
#endif
...
struct CD3DX12_DEPTH_STENCIL_DESC2 : public D3D12_DEPTH_STENCIL_DESC2
{
        ...
        BOOL depthBoundsTestEnable) noexcept
    {
        ...
        FrontFace.StencilPassOp = frontStencilPassOp;
        FrontFace.StencilFunc = frontStencilFunc;
        FrontFace.StencilReadMask = D3D12_DEFAULT_STENCIL_READ_MASK;
        FrontFace.StencilWriteMask = D3D12_DEFAULT_STENCIL_WRITE_MASK;

        BackFace.StencilFailOp = backStencilFailOp;
        BackFace.StencilDepthFailOp = backStencilDepthFailOp;
        BackFace.StencilPassOp = backStencilPassOp;
        BackFace.StencilFunc = backStencilFunc;
        BackFace.StencilReadMask = D3D12_DEFAULT_STENCIL_READ_MASK;
        BackFace.StencilWriteMask = D3D12_DEFAULT_STENCIL_WRITE_MASK;
...
//------------------------------------------------------------------------------------------------
struct CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC
{
    const void* pSerializedBlob;
    SIZE_T SerializedBlobSizeInBytes;

    CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC() noexcept
        : pSerializedBlob(nullptr), SerializedBlobSizeInBytes(0)
    {
    }

    explicit CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC(const CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC& o) noexcept
        : pSerializedBlob(o.pSerializedBlob), SerializedBlobSizeInBytes(o.SerializedBlobSizeInBytes)
    {
    }

    explicit CD3DX12_SERIALIZED_ROOT_SIGNATURE_DESC(const void* pData, SIZE_T size) noexcept
        : pSerializedBlob(pData), SerializedBlobSizeInBytes(size)
    {
    }
};
